...
export function CssFlexboxAlignContentPage(): JSX.Element {
  const [index, setIndex] = useState(0);
  const data = Datas[index] as FlexStyle['alignContent'];

  return (
    <View style={styles.container}>
      <View style={[styles.boxesContainer, {alignContent: data}]}>
